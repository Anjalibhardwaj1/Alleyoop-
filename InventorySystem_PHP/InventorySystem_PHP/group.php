  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-info pull-right btn-sm"> Add Package</a>
    </div>
        ...
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <?php if($a_group['group_status'] === '1'): ?>
            <span class="label label-success"><?php echo "In Use"; ?></span>
          <?php else: ?>
            <span class="label label-danger"><?php echo "Recieved"; ?></span>
          <?php endif;?>
           </td>
           <td class="text-center">
             <div class="btn-group">
